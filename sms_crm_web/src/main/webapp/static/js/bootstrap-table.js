! function(a) {
    ...
    o.DEFAULTS = {
    	...
    	if(a=="last"){
    		this.options.pageNumber = this.options.totalPages, this.updatePagination()
    	}else if(a=="first"){
    		this.options.pageNumber = 1, this.updatePagination()
    	}else {    		
