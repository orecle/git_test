                    ...
                    <table class="helpbox">
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <input class="inp-inp" type="text" name="email" id="email" placeholder=""
                                       value="${session_user.email}"/>无账号可不填写
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;padding-top: 0;">
                                ...
                                <p>
                                    当前字数：<span style="color: #FD0000;" class="dxlength">0</span>个，剩余字数：<span
                                        style="color: #FD0000;" class="s-dxlength">0</span>个
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <input style="text-align: left;" class="inp-inp imp" type="text" name="contact"
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <input style="text-align: left;" class="inp-inp imp" type="text" name="phone" id="phone"
                                       placeholder=""/>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <input class="inp-inp imp reg-code" type="text" name="verifyCode" id="verifyCode"
                                       placeholder=""/>
                            </td>
                        </tr>
