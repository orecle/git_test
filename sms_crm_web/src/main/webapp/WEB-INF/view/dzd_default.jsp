...
<div region="north" border="false" class="h-box">
    <div class="head">
        <div class="logo">
        		...
        		<div class="announcement-box" style="height: 34px;">      
        		<div style="display:table;width: 100%;">
        			<div style="display:table-cell;height: 34px;vertical-align: middle;">
        				<span id="top_notice">${session_alise_group.notice}</span>
        			</div>
