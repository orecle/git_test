...
<input type="hidden" id="invalidCurrentPage"  value="1"/>
	...
	<table class="qftab">
		...
		<div style="display:inline-block;">
			<div style="padding-left:24px;text-align:left;padding-bottom:10px;padding-top:10px">
				<p style="margin-bottom:7px;font-size:12px">操作方法：1、导入号码文件 > 2、选择运营商号码（可多选） > 3、发送短信或导出号码 
				<p/>
				<div class="inp-box">
				<input type="button" id="start-upload"  class="f-btn" value="导入号码" data-toggle="modal" data-target="#upload_file"/>
				<input type="button" style="margin-left:10px;margin-right:10px" id="send_btn"  class="f-btn" value="发送短信" />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="alwd-upload-inp">
                    <li>
                        <form id="uploadFile" method="post" class="flex-c" enctype="multipart/form-data"
                            ...
                            <input type='text' name='filerout' id='textfield' class='fileli  inp-box-inp'
                             readonly="readonly" style="width:227px;"/>
                            
								
                            <input id="file_uploadFile" class="f-btn" type='button' class='btn' value='浏览...'  onclick="$('#input_uploadFile').click();" 
                                  />
                    ...
                    <li class="flex-c proge_li" style="font-size: 10px;margin-top:20px;text-align:left;">
		                          提示：支持导入 txt 和 Excel 格式号码文件，纵向每行一个手机号码。
		                    </li>
