...
public class SmsUser extends BasePage{
    ...
    private Integer unknownSucceedNum;  //未知成功数量
    private Integer unknownFailureNum;  //未知失败数量
    private Integer unknowNnknownNum;  //未知失败数量
    private Integer sumUnknownSucceedNum;  //总未知成功数量
    private Integer sumUnknownFailureNum;  //总未知失败数量
    private Integer sumUnknowNnknownNum;  //总未知失败数量
	...
	public Integer getUnknowNnknownNum()
	{
		return unknowNnknownNum;
	}

	public void setUnknowNnknownNum(Integer unknowNnknownNum)
	{
		this.unknowNnknownNum = unknowNnknownNum;
	}

	public Integer getSumUnknowNnknownNum()
	{
		return sumUnknowNnknownNum;
	}

	public void setSumUnknowNnknownNum(Integer sumUnknowNnknownNum)
	{
		this.sumUnknowNnknownNum = sumUnknowNnknownNum;
	}

	public Integer getSumUnknownSucceedNum()
	{
		return sumUnknownSucceedNum;
	}

	public void setSumUnknownSucceedNum(Integer sumUnknownSucceedNum)
	{
		this.sumUnknownSucceedNum = sumUnknownSucceedNum;
	}

	public Integer getSumUnknownFailureNum()
	{
		return sumUnknownFailureNum;
	}

	public void setSumUnknownFailureNum(Integer sumUnknownFailureNum)
	{
		this.sumUnknownFailureNum = sumUnknownFailureNum;
	}
